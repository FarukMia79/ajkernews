...
export default [
    {
        ...
        children: [
            ...
            { path: 'divisions', name: 'adminDivisions', component: () => import('../backEnd/page/division/DivisionIndex.vue') },
            { path: 'divisions/create', name: 'adminCreateDivision', component: () => import('../backEnd/page/division/DivisonCreate.vue') },
            { path: 'divisions/:id/edit', name: 'adminEditDivision', component: () => import('../backEnd/page/division/DivisionEdit.vue') },
            ...
            { path: 'video-gallery/index', name: 'adminVideoGalleryIndex', component: () => import('../backEnd/page/gallery/videoGallery/VideoIndex.vue') },
            { path: 'video-gallery/edit/:id', name: 'adminVideoEdit', component: () => import('../backEnd/page/gallery/videoGallery/VideoEdit.vue') },
