            ...
            <div class="p-6 md:p-10">
                <form @submit.prevent class="space-y-6">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <select class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 outline-none focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all cursor-pointer">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" placeholder="উদা: ক্রিকেট বা ফুটবল" 
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" placeholder="cricket" 
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center gap-6 pt-6 border-t border-gray-50">
                        <div class="flex items-center gap-4">
                            ...
                            <select class="bg-gray-50 border border-gray-200 rounded-lg px-4 py-2 outline-none focus:ring-2 focus:ring-blue-500 transition cursor-pointer">
                        ...
                        <div class="flex items-center gap-4 w-full md:w-auto">
                            ...
                            <button class="flex-1 md:flex-none bg-[#003557] hover:bg-[#004a7c] text-white px-10 py-3 rounded-xl font-bold shadow-lg shadow-blue-900/20 transition-all transform active:scale-95 flex items-center justify-center gap-2">
