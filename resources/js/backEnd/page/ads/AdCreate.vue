<template>
    <div class="max-w-5xl mx-auto p-2 md:p-6 font-sans">
        <div class="flex justify-between items-center mb-8 bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
            <div>
                <h2 class="text-2xl font-black text-gray-800 tracking-tight">নতুন বিজ্ঞাপন যোগ করুন</h2>
                <nav class="flex items-center gap-2 text-sm text-gray-500 mt-1">
                    <span>অ্যাডমিন</span>
                    <i class="fa-solid fa-chevron-right text-[10px]"></i>
                    <router-link to="/admin/advertisements"
                        class="hover:text-blue-600 font-medium">বিজ্ঞাপন</router-link>
                    <i class="fa-solid fa-chevron-right text-[10px]"></i>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
                    <form @submit.prevent="submitForm" class="p-6 md:p-10 space-y-6">
                        ...
                        <div
                            ...
                            <button type="submit"
                                ...
                                <i class="fa-solid fa-check-circle"></i> বিজ্ঞাপন সেভ করুন
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <div class="space-y-6">
                <div class="bg-white p-6 rounded-3xl shadow-md border border-gray-100">
                    ...
                    <div
                        ...
                        <div class="space-y-2">
                            <i
                                class="fa-solid fa-cloud-arrow-up text-3xl text-gray-300 group-hover:text-blue-500 transition-all"></i>
