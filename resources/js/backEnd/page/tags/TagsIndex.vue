    ...
    <div class="p-2 md:p-6 font-sans max-w-[1600px] mx-auto relative">
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            <div class="w-full lg:w-1/3">
                <div
                    class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden sticky top-6">
                    ...
                    <form @submit.prevent="submitForm" class="p-6 space-y-5">
                        <div class="flex flex-col gap-2">
                            ...
                            <input v-model="form.name" type="text" placeholder="উদা: বাজেট ২০২৪ বা নির্বাচন"
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input v-model="form.slug" type="text" placeholder="উদা: budget-2024"
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="bg-gray-50/50 border-b border-gray-100">
                                    <th class="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider">আইডি
                                    </th>
                                    <th class="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider">ট্যাগ
                                        নাম</th>
                                    <th class="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider">স্লাগ
                                    </th>
                                    <th
            ...
            <div class="bg-white w-full max-w-md rounded-3xl shadow-2xl z-10 overflow-hidden transform transition-all">
                <div class="bg-[#003557] p-5 text-white flex justify-between items-center">
                    ...
                    <button @click="isEditModalOpen = false"
                        class="hover:bg-white/20 p-2 rounded-full transition cursor-pointer">
                ...
                <form @submit.prevent class="p-8 space-y-6">
                    ...
                    <div class="flex gap-3 pt-4">
                        <button type="button" @click="isEditModalOpen = false"
                            class="flex-1 py-3 text-gray-500 font-bold hover:bg-gray-100 rounded-2xl transition cursor-pointer">বাতিল</button>
                        <button type="submit"
                            class="flex-1 bg-[#003557] hover:bg-[#004a7c] text-white py-3 rounded-2xl font-bold shadow-lg transition-all transform active:scale-95 cursor-pointer">আপডেট
                            করুন</button>
                    </div>
                </form>
            </div>
...
export default {
    ...
    methods: {
        ...
        generateSlug() {
            ...
            let text = transliterate(this.form.name);
        ...
        submitForm() {
            ...
            axios.post('/api/tags/store', formData)
                .then(response => {
